...
<main class="mx-auto min-h-[calc(100vh-150px)] max-w-6xl px-5 py-10 lg:px-8 lg:py-14">
  ...
  <section class="mt-6 grid gap-6 lg:grid-cols-[1fr_280px]">
    <div id="pitch" class="relative min-h-[390px] overflow-hidden rounded-[30px] border border-white/15 bg-gradient-to-b from-emerald-700/80 to-emerald-900/90 p-2 shadow-uno sm:min-h-[620px] sm:p-8">
      ...
      @if ($locked)
        <div class="relative flex min-h-[350px] flex-col justify-between gap-2 py-2 sm:min-h-[560px] sm:gap-5 sm:py-4">
      ...
      @else
        <div id="slots" class="relative flex min-h-[350px] flex-col justify-between gap-2 py-2 sm:min-h-[560px] sm:gap-5 sm:py-4"></div>
      @endif
    </div>
